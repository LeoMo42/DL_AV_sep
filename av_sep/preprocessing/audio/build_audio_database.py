...
import librosa
import numpy as np
import av_sep.models.lib.utils as utils
import itertools
import time
import random
import math
...
class AudioDatabaseBuilder:
    @staticmethod
    def run(rootpath, av_range, max_num_sample=50):
        # Parameter
        RANGE = av_range
        WAV_REPO_PATH = rootpath + 'audio/norm_audio_train'
        DATABASE_REPO_PATH = rootpath + 'audio/AV_model_database'
        FRAME_LOG_PATH = rootpath + 'video/valid_frame.txt'
        NUM_SPEAKER = 2
        MAX_NUM_SAMPLE = max_num_sample  # 50000 is too much
        ...
        @timit
        def generate_path_list(sample_range=RANGE, repo_path=WAV_REPO_PATH, frame_path=FRAME_LOG_PATH):
            '''
        ...
        def train_test_split(dataset_log_path, data_range=[0, 50000], test_ratio=0.1, shuffle=True,
